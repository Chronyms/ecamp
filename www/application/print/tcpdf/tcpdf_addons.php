    ...
    if (!class_exists('TCPDF_ADDONS')) {
        class TCPDF_ADDONS extends TCPDF
        {
            public function Header()
            {
                ...
                $this->SetXY(10, 4);
                $this->drawTextBox($name_and_short_name, $w - 20, 4, 'R', 'T', 0);
                $this->SetXY(10, 7);
                $this->drawTextBox($print_data->camp->ca_name . ", " . $print_data->camp->ca_zipcode . " " . $print_data->camp->ca_city, $w - 20, 4, 'C', 'T', 0);
                $this->SetXY(10, 7);
                $this->drawTextBox($first_day->getString('d.m.Y') . " - " . $last_day->getString('d.m.Y'), $w - 20, 4, 'L', 'T', 0);
                $this->SetXY(10, 7);
                $this->drawTextBox($main_leaders, $w - 20, 8, 'R', 'T', 0);
                ...
                if ($print_data->camp->is_course) {
                    ...
                    $this->SetXY(10, 10);
                    $this->drawTextBox($lkbs, $w - 20, 4, 'L', 'T', 0);
                    $this->SetXY(10, 10);
                    $this->drawTextBox('Kurstyp: ' . $print_data->camp->coursetype, $w - 20, 4, 'C', 'T', 0);
                }
            ...
            public function drawTextBox($strText, $w, $h, $align='L', $valign='T', $border=1)
            {
                $xi=$this->GetX();
                $yi=$this->GetY();
            ...
            public function drawRows($w, $h, $txt, $border=0, $align='J', $fill=0, $maxline=0, $prn=0)
            {
