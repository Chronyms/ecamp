 ...
 */
    ...
    class PRINT_CLASS
    {
        ...
        public function SetPrintHeader($set)
        {
            $this->PrintHeader = $set;
        }
        
        public function SetXY($x = false, $y = false)
        {
            if ($x) {
                $this->x = $x;
            }
        ...
        public function Cell($w, $minh, $text, $cbgc, $cs, $ca, $corner)
        {
        ...
        public function LabeldCell($w, $minh = 0, $label, $lbgc, $ls, $la, $text, $tbgc, $ts, $ta, $corner)
        {
            $lc = "";
            $tc = "";
        ...
        public function LabeldTable($w, $content)
        {
            $x = $this->x;
            $y = $this->y;
            $save_x = $x;
            ...
            foreach ($content as $rnr => &$row) {
                foreach ($row as $cnr => &$col) {
                    if (is_array($col)) {
                        ...
                        if ($rnr == 1 && $col['left'] + $col['width'] == 1) {
                            $col['corner'] .= "2";
                        }
                        if ($rnr + $col['rowspan'] - 1 == count($content) && $col['left'] == 0) {
                            $col['corner'] .= "4";
                        }
                        if ($rnr + $col['rowspan'] - 1 == count($content) && $col['left'] + $col['width'] == 1) {
                            $col['corner'] .= "3";
                        }
                    }
                }
        ...
        public function LabeldCols($w, $content)
        {
        ...
        public function LabeldColsRow($w, $row_array, $left, $width)
        {
            $xs = $this->GetX();
            $ys = $this->GetY();
            $ch = 0;
        ...
        public function LabeldColsLabel($w, $label_array, $print_corner = 'true')
        {
            $xs = $this->GetX();
            $ys = $this->GetY();
            $fsize = $this->pdf->GetFontSize() / 2;
            ...
            foreach ($label_array as $nr => $label) {
                $corner = "";
                if ($print_corner && $nr == 1) {
                    $corner .= "1";
                }
                if ($print_corner && $nr == count($label_array)) {
                    $corner .= "2";
                }
        ...
        public function Table($w, $content)
        {
            $ty = $this->GetY();
            $tx = $this->GetX();
            $cl = array();
        ...
        public function TableRow($w, $text, $style = "", $align = "L", $offset = 0)
        {
        ...
        public function EventInstance($event_instance_id)
        {
