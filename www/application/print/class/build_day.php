 ...
 */
    ...
    class print_build_day_class
    {
        ...
        public function print_build_day_class($data)
        {
            $this->data = $data;
        }
        
        public function build($pdf, $day)
        {
            $pdf->AddPage('P', 'A4');
        ...
        public function joblist($pdf, $day)
        {
            $this->y = 55;
            ...
            foreach ($day->job as $job) {
                ...
                if ($job_num % $row_num != 0 && $job_num % $row_num >= $row) {
                    $col_num++;
                }
        ...
        public function event_list($pdf, $day)
        {
            //	Tabellenkopf:
            // ===============
        ...
        public function marker($pdf, $day)
        {
            $c_date = new c_date();
