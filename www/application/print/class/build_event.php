 ...
 */
    ...
    class print_build_event_class
    {
        ...
        public function print_build_event_class($data)
        {
            $this->data = $data;
        }
        ...
        public function build_h($pdf, $event_instance)
        {
            $return = 0;
            
            $return += $this->title_h($pdf, $event_instance);
            
            if ($event_instance->event->category->form_type == 1) {
                $return += $this->ls_header_h($pdf, $event_instance);
            }
            if ($event_instance->event->category->form_type == 2) {
                $return += $this->la_header_h($pdf, $event_instance);
            }
            if ($event_instance->event->category->form_type == 3) {
                $return += $this->lp_header_h($pdf, $event_instance);
            }
            if ($event_instance->event->category->form_type == 4) {
                $return += $this->ka_header_h($pdf, $event_instance);
            }
        ...
        public function build($pdf, $event_instance)
        {
            ...
            if ($event_instance->event->category->form_type == 1) {
                $this->build_assi($pdf, $event_instance, 'ls_header', 'ls_header_h');
            }
            if ($event_instance->event->category->form_type == 2) {
                $this->build_assi($pdf, $event_instance, 'la_header', 'la_header_h');
            }
            if ($event_instance->event->category->form_type == 3) {
                $this->build_assi($pdf, $event_instance, 'lp_header', 'lp_header_h');
            }
            if ($event_instance->event->category->form_type == 4) {
                $this->build_assi($pdf, $event_instance, 'ka_header', 'ka_header_h');
            }
        ...
        public function build_assi($pdf, $event_instance, $build_func, $h_func)
        {
        ...
        public function title_h($pdf, $event_instance)
        {
            return 17;
        }
        
        public function title($pdf, $event_instance)
        {
        ...
        public function ls_header_h($pdf, $event_instance)
        {
            $wl = 120;
            $wr = 70;
        ...
        public function ls_header($pdf, $event_instance)
        {
            $wl = 120;
            $wr = 70;
        ...
        public function la_header_h($pdf, $event_instnace)
        {
            $wl = 120;
            $wr = 70;
        ...
        public function la_header($pdf, $event_instance)
        {
            $wl = 120;
            $wr = 70;
        ...
        public function lp_header_h($pdf, $event_instance)
        {
            return $this->ls_header_h($pdf, $event_instance);
        }
        
        public function lp_header($pdf, $event_instance)
        {
            $this->ls_header($pdf, $event_instance);
        }
        
        
        public function ka_header_h($pdf, $event_instance)
        {
            $wl = 120;
            $wr = 70;
        ...
        public function ka_header($pdf, $event_instance)
        {
            $wl = 120;
            $wr = 70;
        ...
        public function ablauf_h($pdf, $event_instance)
        {
            $return = 0;
        ...
        public function ablauf($pdf, $event_instance)
        {
            $pdf->SetFillColor(200, 200, 200);
            $pdf->SetFont('', 'B', 10);
        ...
        public function material_h($pdf, $event_instance)
        {
            $lines1 = 0;
        ...
        public function material($pdf, $event_instance)
        {
            $max_h = 5;
        ...
        public function siko_h($pdf, $event_instance)
        {
            return 5 * max(1, $pdf->getNumLines($event_instance->event->seco, 190)) + 5;
        }
        
        public function siko($pdf, $event_instance)
        {
            $pdf->SetFont('', 'B', 10);
        ...
        public function notes_h($pdf, $event_instance)
        {
            return 5 * max(1, $pdf->getNumLines($event_instance->event->notes, 190)) + 5;
        }
        
        public function notes($pdf, $event_instance)
        {
            $pdf->SetFont('', 'B', 10);
        ...
        public function marker($pdf, $event_instance)
        {
            $c_date = new c_date();
