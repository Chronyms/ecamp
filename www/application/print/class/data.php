 ...
 */
	...
	class print_data_class
	{
		...
		function load_content()
		{
			...
			while( $user = mysqli_fetch_assoc( $result ) ){	$this->user[ $user['id'] ] = new print_data_user_class( $user, $this );	}
			...
			$result = mysqli_query($GLOBALS["___mysqli_ston"],  $query );
			while( $subcamp = mysqli_fetch_assoc( $result ) ){	$this->subcamp[ $subcamp['id'] ] = new print_data_subcamp_class( $subcamp, $this ); }
			...
			$result = mysqli_query($GLOBALS["___mysqli_ston"],  $query );
			while( $day = mysqli_fetch_assoc( $result ) ){	$this->day[ $day['id'] ] = new print_data_day_class( $day, $this );	}
			
			$query = "SELECT event.* FROM event WHERE camp_id = " . $this->camp_id;
			$result = mysqli_query($GLOBALS["___mysqli_ston"],  $query );
			while( $event = mysqli_fetch_assoc( $result ) ){	$this->event[ $event['id'] ] = new print_data_event_class( $event, $this );	}
			...
			$result = mysqli_query($GLOBALS["___mysqli_ston"],  $query );
			while( $event_detail = mysqli_fetch_assoc( $result ) ){	$this->event_detail[ $event_detail['id'] ] = new print_data_event_detail_class( $event_detail, $this );	}
			...
			$result = mysqli_query($GLOBALS["___mysqli_ston"],  $query );
			while( $event_instance = mysqli_fetch_assoc( $result ) ){	$this->event_instance[ $event_instance['id'] ] = new print_data_event_instance_class( $event_instance, $this );	}
			...
			$result = mysqli_query($GLOBALS["___mysqli_ston"],  $query );
			while( $event_responsible = mysqli_fetch_assoc( $result ) ){	$this->event[ $event_responsible[ 'event_id' ] ]->add_event_responsible( $this->user[ $event_responsible[ 'user_id' ] ] );	}
			...
			$result = mysqli_query($GLOBALS["___mysqli_ston"],  $query );
			while( $course_aim = mysqli_fetch_assoc( $result ) ){	$this->event_aim[ $course_aim[ 'id' ] ] = new print_data_event_aim_class( $course_aim, $this );	}
			...
			$result = mysqli_query($GLOBALS["___mysqli_ston"],  $query );
			while( $course_checklist = mysqli_fetch_assoc( $result ) ){	$this->event_checklist[ $course_checklist[ 'id' ] ] = new print_data_event_checklist_class( $course_checklist, $this );	}

			$query = "SELECT mat_list.* FROM mat_list WHERE mat_list.camp_id = " . $this->camp_id;
			$result = mysqli_query($GLOBALS["___mysqli_ston"],  $query );
			while( $mat_list = mysqli_fetch_assoc( $result ) ){	$this->mat_list[ $mat_list[ 'id' ] ] = new print_data_mat_list( $mat_list, $this );	}
			...
			$result = mysqli_query($GLOBALS["___mysqli_ston"],  $query );
			while( $mat_event = mysqli_fetch_assoc( $result ) ){	$this->mat_event[ $mat_event[ 'id' ] ] = new print_data_mat_event( $mat_event, $this );	}
			...
			$result = mysqli_query($GLOBALS["___mysqli_ston"],  $query );
			while( $job_day = mysqli_fetch_assoc( $result ) ){	$this->day[ $job_day[ 'day_id' ] ]->add_job( $job_day );	}
		}
