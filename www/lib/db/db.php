 ...
 */
    ...
    */
    ...
    class db
    {
        ...
        {
            if (!array_key_exists($table, $this->_meta->config)) {
                return false;
            }
    ...
    class db_table
    {
        ...
        public function db_table($table, $config, $db)
        {
            $this->_meta = new o();
            $this->_meta->config = $config;
            $this->_meta->db = $db;
        ...
        public function waiting_table_is_loaden($t)
        {
    ...
    class db_row
    {
        ...
        public function db_row($row, $config, $db_table)
        {
            $this->_meta = new o();
            $this->_meta->config = $config;
